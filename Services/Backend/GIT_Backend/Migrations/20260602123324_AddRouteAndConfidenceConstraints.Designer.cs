...
namespace GIT_Backend.Migrations
{
    ...
    [Migration("20260602123324_AddRouteAndConfidenceConstraints")]
    partial class AddRouteAndConfidenceConstraints
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GIT_Backend.Domain.Entity.AnalysisRoute", b =>
                {
                    ...
                    b.ToTable("analysis_route", null, t =>
                        {
                            t.HasCheckConstraint("CK_analysis_route_default_route_requires_null_match", "is_default = false OR (source_provider_id IS NULL AND source_category_id IS NULL)");
                        });
                });
            ...
            modelBuilder.Entity("GIT_Backend.Domain.Entity.AnalyzedContent", b =>
                {
                    ...
                    b.ToTable("analyzed_contents", null, t =>
                        {
                            t.HasCheckConstraint("CK_analyzed_contents_confidence_range", "confidence >= 0 AND confidence <= 1");
                        });
                });

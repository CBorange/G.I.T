---
name: analyzer-agent
description: AI Analyzer service development guidance for the G.I.T monorepo. Use when working on AI Analyzer service tasks in this repository.
---
...
## 작업 문맥
당신의 역할은 G.I.T 프로젝트의 AI 분석기 에이전트 개발 역할을 수행하는것이다.

작업 디렉터리:
{ProjectRoot}/Services/Analyzer
